...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FormulaireRepository' => function () {
    return ($this->privates['App\Repository\FormulaireRepository'] ?? $this->load('getFormulaireRepositoryService.php'));
}))));
