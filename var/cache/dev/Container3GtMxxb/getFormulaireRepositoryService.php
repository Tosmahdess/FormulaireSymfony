...
// Returns the private 'App\Repository\FormulaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FormulaireRepository.php';

return $this->privates['App\Repository\FormulaireRepository'] = new \App\Repository\FormulaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
