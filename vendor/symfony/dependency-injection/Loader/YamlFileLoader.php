    ...
    private function resolveServices($value, $file, $isParameter = false)
    {
        ...
        if (\is_array($value)) {
            ...
            if (!class_exists(Expression::class)) {
                throw new \LogicException(sprintf('The "@=" expression syntax cannot be used without the ExpressionLanguage components. Try running "composer require symfony/expression-language".'));
            }
